...
// Copies a fragment of a buffer to another.
buffer.copy = function(inBuffer, inOffset, outBuffer, outOffset, length) {
  let inView = new Uint8Array(inBuffer, inOffset, length);
  let outView = new Uint8Array(outBuffer, outOffset, length);
  outView.set(inView);
}
